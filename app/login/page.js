...
export default function Login() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0a0a0f] text-white flex items-center justify-center px-5 py-10">

      {/* ── Animated Background Orbs ── */}
      <div className="absolute w-[500px] h-[500px] bg-blue-600 rounded-full blur-[180px] opacity-20 -top-40 -right-40 animate-pulse-slow" />
      <div className="absolute w-[400px] h-[400px] bg-purple-600 rounded-full blur-[160px] opacity-15 -bottom-32 -left-32 animate-pulse-slow2" />
      <div className="absolute w-[300px] h-[300px] bg-cyan-600 rounded-full blur-[140px] opacity-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-float" />
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-up">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 mb-4 shadow-lg shadow-blue-500/25 animate-float-logo">
        ...
        {/* Glass Card */}
        <div className="bg-white/[0.06] border border-white/10 rounded-3xl backdrop-blur-2xl p-6 sm:p-8 shadow-2xl shadow-blue-500/5 hover:shadow-blue-500/10 transition-shadow duration-500">
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/[0.06] border border-white/10 rounded-xl pl-11 pr-4 py-3.5 text-sm text-white placeholder-gray-500 outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 hover:border-white/20 transition-all duration-300"
                />
              </div>
            </div>
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onKeyDown={handleKeyPress}
                  className="w-full bg-white/[0.06] border border-white/10 rounded-xl pl-11 pr-12 py-3.5 text-sm text-white placeholder-gray-500 outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 hover:border-white/20 transition-all duration-300"
                />
                <button
                  type="button"
