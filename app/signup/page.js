        ...
        <div className="relative z-10 w-full max-w-md animate-fade-up">
          ...
          <div className="mt-8 grid grid-cols-3 gap-3">
            {[
              ...
              <div key={feature.label} className="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-white/15 transition-all duration-300 hover:scale-105">
